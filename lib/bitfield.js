...
Bitfield.prototype = {
  ...
  readInt: function() {
    ...
    return accum + this.read(bitDepth);
  },
  ...
  asUnicode: function() {
    return String.fromCharCode.apply(null, new Uint16Array(this.buf.buffer, 0, Math.ceil(this.buf.byteLength/2)));
  },
};
